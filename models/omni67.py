...
class CMDM(torch.nn.Module):
    def __init__(self, args, modeltype, njoints=67, nfeats=1, translation=True, pose_rep='rot6d', glob=True, glob_rot=True,
    ...
    def cmdm_forward(self, x, timesteps, y=None, weight=1.0):
        ...
        guided_hint = self.input_hint_block(y['hint'].float())  # [L, b, dim]
